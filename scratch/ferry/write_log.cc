...
//	const std::string str = "obayashiIOFiles/Log/ClusterViewer/ClusterViewer_"+oss_run.str()+".txt";
...
//		oss_delay << simple::MyBuilding::GetFloodingInterval();
	...
	const std::string str = "obayashiIOFiles/Log/obayashi/" + mode + "/" + quickhello + "/" + eraseblock + "/" + std::to_string(simple::MyBuilding::GetNumUsers()) + "/ClusterInfo/ClusterMemberAverage/ClusterMemberAverage_" +std::to_string(simple::MyBuilding::GetRun()) + ".txt";
...
//		oss_delay << simple::MyBuilding::GetFloodingInterval();
	...
	const std::string str = "obayashiIOFiles/Log/obayashi/" + mode + "/" + quickhello + "/" + eraseblock + "/" + std::to_string(simple::MyBuilding::GetNumUsers()) + "/ClusterInfo/ClusterMemberSize/ClusterMemberSize_" +std::to_string(simple::MyBuilding::GetRun()) + ".txt";
	const char *filename = str.c_str();
//		std::string str = "ClusterViewer/"+oss_delay.str()+"/ClusterViewer_"+oss_run.str()+".txt";
//	str.copy(filename,str.size());
//	filename[str.size()] = '\0';
...
//		oss_delay << simple::MyBuilding::GetFloodingInterval();
	...
	const std::string str = "obayashiIOFiles/Log/obayashi/" + mode + "/" + quickhello + "/" + eraseblock + "/" + std::to_string(simple::MyBuilding::GetNumUsers()) + "/ClusterInfo/ClusterHopInfo/ClusterHopInfo_" +std::to_string(simple::MyBuilding::GetRun()) + ".txt";
	const char *filename = str.c_str();
//		std::string str = "ClusterViewer/"+oss_delay.str()+"/ClusterViewer_"+oss_run.str()+".txt";
//	str.copy(filename,str.size());
//	filename[str.size()] = '\0';
...
//		oss_delay << simple::MyBuilding::GetFloodingInterval();
	...
	std::string str = "obayashiIOFiles/Log/obayashi/" + mode + "/" + quickhello + "/" + eraseblock + "/" + std::to_string(simple::MyBuilding::GetNumUsers()) + "/SectionData/SendSectionDataSize_" +std::to_string(simple::MyBuilding::GetRun()) + ".txt";
//		std::string str = "ClusterViewer/"+oss_delay.str()+"/ClusterViewer_"+oss_run.str()+".txt";
	str.copy(filename,str.size());
	filename[str.size()] = '\0';
...
//		oss_delay << simple::MyBuilding::GetFloodingInterval();
	...
	std::string str = "obayashiIOFiles/Log/obayashi/" + mode + "/" + quickhello + "/" + eraseblock + "/" + std::to_string(simple::MyBuilding::GetNumUsers()) + "/Time/time_" +std::to_string(simple::MyBuilding::GetRun()) + ".txt";
//		std::string str = "ClusterViewer/"+oss_delay.str()+"/ClusterViewer_"+oss_run.str()+".txt";
	str.copy(filename,str.size());
	filename[str.size()] = '\0';
...
//		oss_delay << simple::MyBuilding::GetFloodingInterval();
	...
	std::string str = "obayashiIOFiles/Log/obayashi/" + mode + "/" + quickhello + "/" + eraseblock + "/" + std::to_string(simple::MyBuilding::GetNumUsers()) + "/Time/EvacuationTime_" +std::to_string(simple::MyBuilding::GetRun()) + ".txt";
//		std::string str = "ClusterViewer/"+oss_delay.str()+"/ClusterViewer_"+oss_run.str()+".txt";
	str.copy(filename,str.size());
	filename[str.size()] = '\0';
...
//		oss_delay << simple::MyBuilding::GetFloodingInterval();
	...
	std::string str = "obayashiIOFiles/Log/obayashi/" + mode + "/" + quickhello + "/" + eraseblock + "/" + std::to_string(simple::MyBuilding::GetNumUsers()) + "/Escape/escape_" +std::to_string(simple::MyBuilding::GetRun()) + ".txt";
//		std::string str = "ClusterViewer/"+oss_delay.str()+"/ClusterViewer_"+oss_run.str()+".txt";
	str.copy(filename,str.size());
	filename[str.size()] = '\0';
...
void WriteLog::Initialize_Logfile_for_UserTrackingLog(){
	...
	for(auto itr = traceuserlist.begin();itr!=traceuserlist.end();++itr){
		auto it = *itr;
		std::string str = "obayashiIOFiles/Log/obayashi/" + mode + "/" + quickhello + "/" + eraseblock + "/" + std::to_string(simple::MyBuilding::GetNumUsers()) + "/UserInfo/User" + std::to_string(it) + "_"+std::to_string(simple::MyBuilding::GetRun()) + ".txt";
		str.copy(filename,str.size());
		filename[str.size()] = '\0';
		// output to file
		std::ofstream fout;
...
//	std::string str = "obayashiIOFiles/Log/obayashi/ClusterViewer/ClusterViewer_"+oss_run.str()+".txt";
//		std::string str = "ClusterViewer/"+oss_delay.str()+"/ClusterViewer_"+oss_run.str()+".txt";
	str.copy(filename,str.size());
	filename[str.size()] = '\0';
...
// 		mode="OFF";
// 	}
// 	std::string str = "obayashiIOFiles/Log/obayashi/" + mode + "/" + std::to_string(simple::MyBuilding::GetNumUsers()) + "/testLog/Recv_data.txt";
// 	str.copy(filename,str.size());
// 	filename[str.size()] = '\0';
// 	std::ofstream fout;
// 	fout.open(filename);
	...
	char filename2[1000];
	std::string str2 = "obayashiIOFiles/Log/obayashi/" + mode + "/" + std::to_string(simple::MyBuilding::GetNumUsers()) + "/testLog/testlog.txt";
...
void WriteLog::OutputText_CompleteTime(Time now, uint32_t num, uint32_t userId, uint32_t changeroute, uint32_t changeexit, String m_exitnode){
	// set parameters
	...
	std::string str = "obayashiIOFiles/Log/obayashi/" + mode + "/" + quickhello + "/" + eraseblock + "/" + std::to_string(simple::MyBuilding::GetNumUsers()) + "/Time/time_" +std::to_string(simple::MyBuilding::GetRun()) + ".txt";
//	std::string str = "obayashiIOFiles/Log/obayashi/Time/time_" +std::to_string(simple::MyBuilding::GetRun()) + ".txt";
	str.copy(filename,str.size());
	filename[str.size()] = '\0';
...
void WriteLog::OutputUserTrackingLog(Time now, uint32_t userId,std::list<std::pair<double,double>> shortest, double dst, std::map<std::pair<double,double>,simple::way_node> graph){
	...
	if(result == traceuserlist.end()) {
		...
		std::string str = "obayashiIOFiles/Log/obayashi/" + mode + "/" + quickhello + "/" + eraseblock + "/" + std::to_string(simple::MyBuilding::GetNumUsers()) + "/UserInfo/User" + std::to_string(userId) +"_"+std::to_string(simple::MyBuilding::GetRun()) + ".txt";
		str.copy(filename,str.size());
		filename[str.size()] = '\0';
