...
public:
	...
	void SetWaitStatus (bool flag){isWait = flag;} //2026-04-14
	...
	std::map<String, double> GetExitDistanceMap(void){
		return m_exit_distance_map;
	}
...
//****************************************************************
	...
	void AddUserMovementTimer(Time delay);
