...
private:
	...
	//自分のデータをチェックする関数
	void CheckHelloData(UserData data, Ipv4Address sender);
	void CancelHello();
	...
	void RecvShelterDataAsBroadcast(Ptr<Packet> p);
	...
	void SendUserDataAsUnicast(UserData data,Ipv4Address dst);
	//ルーティングテーブルを送信する
